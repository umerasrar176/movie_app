                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              image: DecorationImage(
                                  image: NetworkImage(
                                      "https://image.tmdb.org/t/p/w500${_images[0]['file_path']}"),
                                  fit: BoxFit.fill)),
                        ),
                        Positioned(
                            top: 0.0,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: ElevatedButton(
                                          ...
                                          child: const Text('Get Tickets', style: TextStyle(fontSize: 30.0),),
                                          /*color: Colors.grey,
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: Row(
                                        ...
                                        children: const [
                                          ...
                                          SizedBox(width: 10.0,),
                                          Text('Watch Trailer', style: TextStyle(fontSize: 30.0, color: Colors.white),),
                                        ],
                                      ),
                                      /* color: Colors.blue,
                                    textColor: Colors.white,*/
